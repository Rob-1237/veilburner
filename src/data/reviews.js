export const reviews = [
  ...
  },
  {
    ...
    fullText: "Veilburner is a black/death metal band from Pennsylvania … With every album, the duo grows and expands their sound. After the last album, I was worried they had taken their ideas as far as they could go and any new music would be too abstract for me. My foot is in my mouth … Although this album is insane with a lot to comprehend, it's presented with a firm foundation. Yes, it crosses a lot of lines, totally erased with chaos but it's a controlled chaos. None of the songs feel too floaty, convoluted, or pretentious. … The twisted compositions only get better as the album is played more and more. This is a trip down a rabbit hole that I'll happily get lost in.",
  ...
  },
  {
    ...
    fullText: "Veilburner have followed up last year's career highlight with something darker, louder, and more dyspeptic. It's only right. Now repent.",
    publication: "No Clean Singing",
  ...
  },
  {
    ...
    fullText: "The review describes 'Glory Glory Grotesque' as a paradoxical track that blends multiple musical elements, characterized by 'Morbid Angel-by-way-of-Deathspell Omega stomp.' The reviewer highlights the song's complexity, noting how it moves between ethereal and violent soundscapes, with 'chittering electronic chirps and a grungy industrial tone' alongside transcendent musical moments that reveal the band's unique artistic vision.",
    publication: "Toilet ov Hell",
    date: "2017",
  ...
  },
  {
    ...
    fullText: "The review describes Veilburner's album as a twisted combination of death, black, and industrial metal that completes a conceptual trilogy exploring transhumanism and nihilism. The reviewer praises the band's ability to create music that is both experimental and coherent, highlighting how each song maintains a sense of unity despite its unconventional structure. The album is characterized by its wild keyboard sounds, demented riffs, and macabre vocal elements that create a unique and compelling listening experience.",
    publication: "Toilet ov Hell",
    date: "2016",
  ...
  {
    quote: "An uncompromisingly bright album, its effervescent synths and heavily effected clean guitars give tracks like first single 'Ever Relapsing Fever' a brilliant, almost garish shade.",
    fullText: "Veilburner's Noumenon is a sophisticated and dynamic metal album that transcends traditional brutality. The reviewer praises the band's ability to craft complex, memorable compositions that blend bright synthesizers, effected guitars, and theatrical vocal performances. While maintaining heavy musical elements reminiscent of bands like Morbid Angel and Deathspell Omega, the album distinguishes itself through its innovative approach to riff structures and sonic textures. As the second installment in a conceptual trilogy, Noumenon represents a significant evolution of the band's sound, expanding and refining their musical approach.",
    publication: "Toilet ov Hell",
    date: "2013",
    album: "Noumenon",
    rating: null,
